...
static std::string thr_key(BaqWordLenMode m)
{
    switch (m)
    {
    case BaqWordLenMode::w2: return "thr_2";
    case BaqWordLenMode::w3: return "thr_3";
    case BaqWordLenMode::w4: return "thr_4";
    case BaqWordLenMode::w6: return "thr_6";
    case BaqWordLenMode::w8: return "thr_8";
    }
...
static size_t block_size_value(BaqBlockSizeMode m)
{
    switch (m)
    {
    case BaqBlockSizeMode::b128: return 128;
    case BaqBlockSizeMode::b256: return 256;
    case BaqBlockSizeMode::b512: return 512;
    }
...
static size_t seg_num_value(BaqSegNumMode m)
{
    switch (m)
    {
    case BaqSegNumMode::s128: return 128;
    case BaqSegNumMode::s256: return 256;
    }
    throw std::invalid_argument("Unknown BaqSegNumMode");
}
