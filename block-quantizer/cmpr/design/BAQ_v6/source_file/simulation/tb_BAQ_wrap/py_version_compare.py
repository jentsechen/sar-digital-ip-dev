...
##############Compare lines##############################################
PRI = 2
compare_lines = 1600*PRI
compare_header_lines = 50*PRI
...
BAQ_I1_error = BAQ_I1_out_np - BAQ_I1_golden_np[0:compare_lines+3]
BAQ_I2_error = BAQ_I2_out_np - BAQ_I2_golden_np[0:compare_lines+3]
BAQ_I3_error = BAQ_I3_out_np - BAQ_I3_golden_np[0:compare_lines+3]
BAQ_I4_error = BAQ_I4_out_np - BAQ_I4_golden_np[0:compare_lines+3]
BAQ_Q1_error = BAQ_Q1_out_np - BAQ_Q1_golden_np[0:compare_lines+3]
BAQ_Q2_error = BAQ_Q2_out_np - BAQ_Q2_golden_np[0:compare_lines+3]
BAQ_Q3_error = BAQ_Q3_out_np - BAQ_Q3_golden_np[0:compare_lines+3]
BAQ_Q4_error = BAQ_Q4_out_np - BAQ_Q4_golden_np[0:compare_lines+3]
...
plt.subplot(4, 1, 1) 
plt.stem(error_x_axis[0:compare_lines+3],BAQ_total_error)
plt.title('total_error (golden VS Out)')
plt.xlabel('n_data*8')
plt.ylabel('Magnitude (unit:1)')
plt.show
plt.subplot(4, 1, 3) 
plt.stem(error_header_x_axis[0:compare_lines+3],BAQ_header_error)
